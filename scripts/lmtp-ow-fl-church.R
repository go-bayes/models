...
names_base_t2_smoker_binary <- select_and_rename_cols(names_base = names_base, baseline_vars = baseline_vars, outcome = "t2_smoker_binary")
...
names_base_t2_alcohol_frequency_z <- select_and_rename_cols(names_base = names_base, baseline_vars = baseline_vars, outcome = "t2_alcohol_frequency_z")
...
names_base_t2_alcohol_intensity_z <- select_and_rename_cols(names_base = names_base, baseline_vars = baseline_vars, outcome = "t2_alcohol_intensity_z")
...
names_base_t2_sfhealth_z <- select_and_rename_cols(names_base = names_base, baseline_vars = baseline_vars, outcome = "t2_sfhealth_z")
...
t2_sfhealth_z_null
here_save(t2_sfhealth_z_null, "t2_sfhealth_z")




names_base_t2_hours_exercise_log_z <- select_and_rename_cols(names_base = names_base, baseline_vars = baseline_vars, outcome = "t2_hours_exercise_log_z")
...
here_save(t2_hours_exercise_log_z_null, "t2_hours_exercise_log_z_null")




names_base_t2_hlth_sleep_hours_z <- select_and_rename_cols(names_base = names_base, baseline_vars = baseline_vars, outcome = "t2_hlth_sleep_hours_z")
...
names_base_t2_hlth_bmi_z <- select_and_rename_cols(names_base = names_base, baseline_vars = baseline_vars, outcome = "t2_hlth_bmi_z")
...
names_base_t2_bodysat_z <- select_and_rename_cols(names_base = names_base, baseline_vars = baseline_vars, outcome = "t2_bodysat_z")
...
names_base_t2_kessler6_sum_z <- select_and_rename_cols(names_base = names_base, baseline_vars = baseline_vars, outcome = "t2_kessler6_sum_z")
...
names_base_t2_hlth_fatigue_z <- select_and_rename_cols(names_base = names_base, baseline_vars = baseline_vars, outcome = "t2_hlth_fatigue_z")
...
names_base_t2_rumination_z <- select_and_rename_cols(names_base = names_base, baseline_vars = baseline_vars, outcome = "t2_rumination_z")
...
names_base_t2_sexual_satisfaction_z <- select_and_rename_cols(names_base = names_base, baseline_vars = baseline_vars, outcome = "t2_sexual_satisfaction_z")
...
names_base_t2_power_no_control_composite_z <- select_and_rename_cols(names_base = names_base, baseline_vars = baseline_vars, outcome = "t2_power_no_control_composite_z")
...
names_base_t2_self_esteem_z <- select_and_rename_cols(names_base = names_base, baseline_vars = baseline_vars, outcome = "t2_self_esteem_z")
...
names_base_t2_self_control_have_lots_z <- select_and_rename_cols(names_base = names_base, baseline_vars = baseline_vars, outcome = "t2_self_control_have_lots_z")
...
here_save(t2_self_control_have_lots_z_null, "t2_self_control_have_lots_z_null")





names_base_t2_self_control_wish_more_reversed_z <- select_and_rename_cols(names_base = names_base, baseline_vars = baseline_vars, outcome = "t2_self_control_wish_more_reversed_z")
...
here_save(t2_self_control_wish_more_reversed_z, "t2_self_control_wish_more_reversed_z")
...
here_save(t2_self_control_wish_more_reversed_z_null, "t2_self_control_wish_more_reversed_z_null")
...
names_base_t2_permeability_individual_z <- select_and_rename_cols(names_base = names_base, baseline_vars = baseline_vars, outcome = "t2_permeability_individual_z")
...
here_save(t2_permeability_individual_z, "t2_permeability_individual_z")
...
here_save(t2_permeability_individual_z_null, "t2_permeability_individual_z_null")
...
names_base_t2_perfectionism_z <- select_and_rename_cols(names_base = names_base, baseline_vars = baseline_vars, outcome = "t2_perfectionism_z")
...
names_base_t2_gratitude_z <- select_and_rename_cols(names_base = names_base, baseline_vars = baseline_vars, outcome = "t2_gratitude_z")
...
names_base_t2_vengeful_rumin_z <- select_and_rename_cols(names_base = names_base, baseline_vars = baseline_vars, outcome = "t2_vengeful_rumin_z")
...
names_base_t2_pwb_your_health_z <- select_and_rename_cols(names_base = names_base, baseline_vars = baseline_vars, outcome = "t2_pwb_your_health_z")
...
names_base_t2_pwb_your_future_security_z <- select_and_rename_cols(names_base = names_base, baseline_vars = baseline_vars, outcome = "t2_pwb_your_future_security_z")
...
here_save(t2_pwb_your_future_security_z, "t2_pwb_your_future_security_z")
...
here_save(t2_pwb_your_future_security_z_null, "t2_pwb_your_future_security_z_null")



names_base_t2_pwb_your_relationships_z <- select_and_rename_cols(names_base = names_base, baseline_vars = baseline_vars, outcome = "t2_pwb_your_relationships_z")
...
here_save(t2_pwb_your_relationships_z_null, "t2_pwb_your_relationships_z_null")




names_base_t2_pwb_standard_living_z <- select_and_rename_cols(names_base = names_base, baseline_vars = baseline_vars, outcome = "t2_pwb_standard_living_z")
...
names_base_t2_lifemeaning_z <- select_and_rename_cols(names_base = names_base, baseline_vars = baseline_vars, outcome = "t2_lifemeaning_z")
...
names_base_t2_lifesat_z <- select_and_rename_cols(names_base = names_base, baseline_vars = baseline_vars, outcome = "t2_lifesat_z")
...
names_base_t2_support_z <- select_and_rename_cols(names_base = names_base, baseline_vars = baseline_vars, outcome = "t2_support_z")
...
names_base_t2_neighbourhood_community_z <- select_and_rename_cols(names_base = names_base, baseline_vars = baseline_vars, outcome = "t2_neighbourhood_community_z")
...
here_save(t2_neighbourhood_community_z_null, "t2_neighbourhood_community_z_null")




names_base_t2_belong_z <- select_and_rename_cols(names_base = names_base, baseline_vars = baseline_vars, outcome = "t2_belong_z")
...
t2_smoker_binary_null <- here_read("t2_smoker_binary_null")


contrast_t2_smoker_binary <- lmtp_contrast(
  t2_smoker_binary,
...
contrast_t2_sfhealth_z <- here_read("contrast_t2_sfhealth_z")
contrast_t2_sfhealth_z_null <- here_read("contrast_t2_sfhealth_z_null")


contrast_t2_sfhealth_z <- lmtp_contrast(
  t2_sfhealth_z,
  ref = t2_sfhealth_z_null, 
  type = "additive")


t2_hours_exercise_log_z <- here_read("t2_hours_exercise_log_z")
t2_hours_exercise_log_z_null <- here_read("t2_hours_exercise_log_z_null")


contrast_t2_hours_exercise_log_z <- lmtp_contrast(
  t2_hours_exercise_log_z,
  ref = t2_hours_exercise_log_z_null, 
  type = "additive")


t2_alcohol_frequency_z <- here_read("t2_alcohol_frequency_z")
t2_alcohol_frequency_z_null <- here_read("t2_alcohol_frequency_z_null")

contrast_t2_alcohol_frequency_z <- lmtp_contrast(
  t2_alcohol_frequency_z,
...
t2_alcohol_intensity_z <- here_read("t2_alcohol_intensity_z")
t2_alcohol_intensity_z_null <- here_read("t2_alcohol_intensity_z_null")


contrast_t2_alcohol_intensity_z <- lmtp_contrast(
  t2_alcohol_intensity_z,
  ref = t2_alcohol_intensity_z_null, 
  type = "additive")

t2_hours_sleep_z<- here_read("t2_hours_sleep_z")
t2_hours_sleep_z_null <- here_read("t2_hours_sleep_z_null")

contrast_t2_hours_sleep_z <- lmtp_contrast(
  t2_hours_sleep_z,
  ref = t2_hours_sleep_z_null, 
  type = "additive")

t2_hours_bmi_z<- here_read("t2_hours_bmi_z")
t2_hours_bmi_z_null <- here_read("t2_hours_bmi_z_null")

contrast_t2_bmi_z <- lmtp_contrast(
  t2_hours_bmi_z,
  ref = t2_bmi_z_null, 
  type = "additive")
...
contrast_t2_bodysat_z <- lmtp_contrast(
  t2_bodysat_z,
  ref = t2_bodysat_z_null, 
  type = "additive")


t2_kessler6_sum_z<- here_read("")
t2_kessler6_sum_z_null <- here_read("t2_kessler6_sum_z_null")

contrast_t2_kessler6_sum_z <- lmtp_contrast(
  t2_kessler6_sum_z,
...
t2_hlth_fatigue_z_null <- here_read("t2_hlth_fatigue_z_null")


contrast_t2_hlth_fatigue_z <- lmtp_contrast(
  t2_hlth_fatigue_z,
...
contrast_t2_rumination_z <- lmtp_contrast(
  t2_rumination_z,
  ref = t2_rumination_z_null, 
  type = "additive")


t2_sexual_satisfaction_z<- here_read("t2_sexual_satisfaction_z")
t2_sexual_satisfaction_z_null <- here_read("t2_sexual_satisfaction_z_null")


contrast_t2_sexual_satisfaction_z <- lmtp_contrast(
  t2_sexual_satisfaction_z,
...
t2_power_no_control_composite_z<- here_read("t2_power_no_control_composite_z")
t2_power_no_control_composite_z_null <- here_read("t2_power_no_control_composite_z_null")


contrast_t2_power_no_control_composite_z <- lmtp_contrast(
  t2_power_no_control_composite_z,
  ref = t2_power_no_control_composite_z_null, 
  type = "additive")

t2_self_esteem_z<- here_read("t2_self_esteem_z")
t2_self_esteem_z_null <- here_read("t2_self_esteem_z_null")

contrast_t2_self_esteem_z <- lmtp_contrast(
  t2_self_esteem_z,
...
t2_perfectionism_z_null <- here_read("t2_perfectionism_z_null")

contrast_t2_perfectionism_z <- lmtp_contrast(
  t2_perfectionism_z,
  ref = t2_perfectionism_z_null, 
  type = "additive")


t2_self_control_have_lots_z<- here_read("t2_self_control_have_lots_z")
t2_self_control_have_lots_z_null <- here_read("t2_self_control_have_lots_z_null")

contrast_t2_self_control_have_lots_z <- lmtp_contrast(
  t2_self_control_have_lots_z,
  ref = t2_self_control_have_lots_z_null, 
  type = "additive")


t2_self_control_wish_more_reversed_z<- here_read("t2_self_control_wish_more_reversed_z")
t2_self_control_wish_more_reversed_z_null <- here_read("t2_self_control_wish_more_reversed_z_null")

contrast_t2_self_control_wish_more_reversed_z <- lmtp_contrast(
  t2_self_control_wish_more_reversed_z,
  ref = t2_self_control_wish_more_reversed_z_null, 
  type = "additive")

t2_permeability_individual_z<- here_read("t2_permeability_individual_z")
t2_permeability_individual_z_null <- here_read("t2_permeability_individual_z_null")

contrast_t2_permeability_individual_z <- lmtp_contrast(
  t2_permeability_individual_z,
...
contrast_t2_gratitude_z <- lmtp_contrast(
  t2_gratitude_z,
  ref = t2_gratitude_z_null, 
  type = "additive")

t2_vengeful_rumin_z<- here_read("t2_vengeful_rumin_z")
t2_vengeful_rumin_z_null <- here_read("t2_vengeful_rumin_z_null")


contrast_t2_vengeful_rumin_z <- lmtp_contrast(
  t2_vengeful_rumin_z,
  ref = t2_vengeful_rumin_z_null, 
  type = "additive")

t2_pwb_your_health_z<- here_read("t2_pwb_your_health_z")
t2_pwb_your_health_z_null <- here_read("t2_pwb_your_health_z_null")


contrast_t2_pwb_your_health_z <- lmtp_contrast(
  t2_pwb_your_health_z,
  ref = t2_pwb_your_health_z_null, 
  type = "additive")

t2_pwb_your_future_security_z<- here_read("t2_pwb_your_future_security_z")
t2_pwb_your_future_security_z_null <- here_read("t2_pwb_your_future_security_z_null")

contrast_t2_pwb_your_future_security_z <- lmtp_contrast(
  t2_pwb_your_future_security_z,
  ref = t2_pwb_your_future_security_z_null, 
  type = "additive")

t2_pwb_your_relationships_z<- here_read("t2_pwb_your_relationships_z")
t2_pwb_your_relationships_z_null <- here_read("t2_pwb_your_relationships_z_null")


contrast_t2_pwb_your_relationships_z <- lmtp_contrast(
  t2_pwb_your_relationships_z,
  ref = t2_pwb_your_relationships_z_null, 
  type = "additive")


t2_pwb_standard_living_z<- here_read("t2_pwb_standard_living_z")
t2_pwb_standard_living_z_null <- here_read("t2_pwb_standard_living_z_null")

contrast_t2_pwb_standard_living_z <- lmtp_contrast(
  t2_pwb_standard_living_z,
...
t2_lifemeaning_z_null <- here_read("t2_lifemeaning_z_null")


contrast_t2_lifemeaning_z <- lmtp_contrast(
  t2_lifemeaning_z,
...
contrast_t2_lifesat_z <- lmtp_contrast(
  t2_lifesat_z,
...
contrast_t2_support_z <- lmtp_contrast(
  t2_support_z,
  ref = t2_support_z_null, 
  type = "additive")

t2_neighbourhood_community_z<- here_read("t2_neighbourhood_community_z")
t2_neighbourhood_community_z_null <- here_read("t2_neighbourhood_community_z_null")


contrast_t2_neighbourhood_community_z <- lmtp_contrast(
  t2_neighbourhood_community_z,
...
contrast_t2_belong_z <- lmtp_contrast(
  t2_belong_z,
