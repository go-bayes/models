...
## This is the script for the study INKUK is leading on trust in science and environmmental attitudes
...
dat_long_full <- dat |>
  ...
  rename(
    ...
    trust_science_our_society_places_too_much_emphasis_reversed =science_trust02r
  ) |>
...
# assocation only # We find a very strong relationship
summary( lm( env_climate_chg_concern ~ trust_science_our_society_places_too_much_emphasis_reversed, data = dat_long) )
...
dt_20 <- dat_long |>
  ...
  mutate(trust_science_our_society_places_too_much_emphasis_reversed_z =
           scale(trust_science_our_society_places_too_much_emphasis_reversed))

hist(dt_20$trust_science_our_society_places_too_much_emphasis_reversed)
table(dt_20$trust_science_our_society_places_too_much_emphasis_reversed)



mean_exposure <- mean(dt_20$trust_science_our_society_places_too_much_emphasis_reversed,
                      na.rm = TRUE)
mean_exposure

max_score <- max(dt_19$trust_science_our_society_places_too_much_emphasis_reversed_z, na.rm = TRUE)
max_score
...
standard_deviation_exposure <-
  coloured_histogram_sd(dt_20, col_name = "trust_science_our_society_places_too_much_emphasis_reversed", binwidth = .5)
...
table(df_clean$t1_trust_science_our_society_places_too_much_emphasis_reversed_z)
