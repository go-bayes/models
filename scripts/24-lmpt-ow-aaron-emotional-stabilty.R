...
A <- "t1_aaron_emotional_stability"

# define exposure
nzavs_exposure <- "aaron_emotional_stability"
exposure_var = c( "aaron_emotional_stability", "not_lost") #
...
min_score <- min(dt_19$aaron_emotional_stability, na.rm = TRUE)
min_score

max_score <- max(dt_19$aaron_emotional_stability, na.rm = TRUE)
max_score
...
table (is.na(dt_check_exposure$aaron_emotional_stability))
...
dt_positivity_full <- dt_check_exposure |>
  ...
  mutate(aaron_emotional_stability_round = round(aaron_emotional_stability, 0))


# test positivity
out <-
  msm::statetable.msm(aaron_emotional_stability_round, id, data = dt_positivity_full)
...
standard_deviation_exposure <-
  coloured_histogram_sd(dt_19, col_name = "aaron_emotional_stability", binwidth = .1)
...
tab_contrast_t2_partner_sat_relationship_z <-
  margot_tab_lmtp(contrast_t2_partner_sat_relationship_z,
                  scale = "RD",
                  new_name = "Gain psychopathy emotional stability: partner relationship satisfaction")
...
tab_contrast_t2_partner_sat_relationship_z_1 <-
  margot_tab_lmtp(contrast_t2_partner_sat_relationship_z_1,
                  scale = "RD",
                  new_name = "Loss psychopathy emotional stability: partner relationship satisfacton")
...
tab_contrast_t2_partner_conflict_in_relationship_z <-
  margot_tab_lmtp(contrast_t2_partner_conflict_in_relationship_z,
                  scale = "RD",
                  new_name = "Gain psychopathy emotional stability: partner conflict in relationship")
...
tab_contrast_t2_partner_kessler6_sum_z<-
  margot_tab_lmtp(contrast_t2_partner_kessler6_sum_z,
                  scale = "RD",
                  new_name = "Gain psychopathy emotional stability: partner Kessler 6 distress")
...
tab_contrast_t2_partner_kessler6_sum_z_1<-
  margot_tab_lmtp(contrast_t2_partner_kessler6_sum_z_1,
                  scale = "RD",
                  new_name = "Loss psychopathy emotional stability: partner Kessler 6 distress")
...
tab_contrast_t2_partner_kessler_latent_depression_z <-
  margot_tab_lmtp(contrast_t2_partner_kessler_latent_depression_z,
                  scale = "RD",
                  new_name = "Gain psychopathy emotional stability: partner Kessler 6 depression")
...
tab_contrast_t2_partner_kessler_latent_depression_z_1 <-
  margot_tab_lmtp(contrast_t2_partner_kessler_latent_depression_z_1,
                  scale = "RD",
                  new_name = "Loss psychopathy emotional stability: partner Kessler 6 depression")
...
tab_contrast_t2_partner_kessler_latent_anxiety_z <-
  margot_tab_lmtp(contrast_t2_partner_kessler_latent_anxiety_z,
                  scale = "RD",
                  new_name = "Gain psychopathy emotional stability: partner Kessler 6 anxiety")
...
tab_contrast_t2_partner_kessler_latent_anxiety_z_1 <-
  margot_tab_lmtp(contrast_t2_partner_kessler_latent_anxiety_z_1,
                  scale = "RD",
                  new_name = "Loss psychopathy emotional stability: partner Kessler 6 anxiety")
...
tab_contrast_t2_partner_self_esteem_z <-
  margot_tab_lmtp(contrast_t2_partner_self_esteem_z,
                  scale = "RD",
                  new_name = "Gain psychopathy emotional stability: partner self-esteem")
...
tab_contrast_t2_partner_self_esteem_z_1<-
  margot_tab_lmtp(contrast_t2_partner_self_esteem_z_1,
                  scale = "RD",
                  new_name = "Loss psychopathy emotional stability: partner self-esteem")
...
tab_contrast_t2_partner_pwi_z <-
  margot_tab_lmtp(contrast_t2_partner_pwi_z,
                  scale = "RD",
                  new_name = "Gain psychopathy emotional stability: partner pers. wellbeing")
...
tab_contrast_t2_partner_pwi_z_1 <-
  margot_tab_lmtp(contrast_t2_partner_pwi_z_1,
                  scale = "RD",
                  new_name = "Loss psychopathy emotional stability: partner pers. wellbeing")
...
tab_contrast_t2_partner_lifesat_z <-
  margot_tab_lmtp(contrast_t2_partner_lifesat_z, scale = "RD", 
                  new_name = "Gain psychopathy emotional stability: partner life satisfaction")
...
tab_contrast_t2_partner_lifesat_z_1 <-
  margot_tab_lmtp(contrast_t2_partner_lifesat_z_1, scale = "RD", new_name = "Loss psychopathy emotional stability: partner life satisfaction")
...
plot_group_tab_gain <- margot_plot(
  group_tab_outcomes_gain,
  type = "RD",
  title = "Gain +1 Psychopathy Emotional Stability: N=1070",
  subtitle = sub_title,
  xlab = "",
  ylab = "",
  estimate_scale = 1,
...
plot_group_tab_loss <- margot_plot(
  ...
  type = "RD",
  title = "Loss +1 Psychopathy Emotional Stability: N=1070",
  subtitle = sub_title,
  xlab = "",
  ylab = "",
  estimate_scale = 1,
